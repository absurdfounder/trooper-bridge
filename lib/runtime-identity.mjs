...
- CrabsHQ paired devices are not the same thing as OpenClaw live nodes. If the Devices UI shows a paired MacBook but OpenClaw Nodes is empty, that machine is available for CrabsHQ device actions only, not native node execution.
