...
- When the human asks for a calculator, dashboard, internal tool, or app smoke test, prefer creating or updating a real workspace app instead of only pasting raw JSX into chat.
